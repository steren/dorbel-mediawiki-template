 ...
 * @ingroup Skins
 */
class SkinStudio extends SkinTemplate {
	/** Using studio. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'studio';
		$this->stylename = 'studio';
 ...
 * @ingroup Skins
 */
class StudioTemplate extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for Studio skin.
...
<?php		}
		...
		wfRunHooks( 'StudioTemplateToolboxEnd', array( &$this ) );
